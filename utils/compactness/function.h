...
namespace voronoi {
    ...
    unsigned int Ah_ave( unsigned int *, int );
    int mostFrequent(int arr[], int n);
    int compare(const void * a, const void * b);
    float calculateMean(int data[], int n);
    float calculateSD(int data[], int n);
    void hist( MetaData * );
    int distinction( Label, Label, int , int);
    void erase_endp( int );
    void erase_aux();
    void erase( MetaData * );
    ...
    /* img_to_site.c */
    void img_to_site( ImageData * , MetaData *);
    ...
    void voronoi_pageseg(LineSegment ** ,unsigned int *, ImageData *, Shape **, unsigned int *, MetaData *);
